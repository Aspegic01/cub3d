...
SRCS = main.c \
       ...
       ./minimap/setup.c ./minimap/map.c ./minimap/player.c ./engine/render.c ./engine/drawline.c ./engine/raycast.c map_parsing_utils.c texture_utils.c utils_c.c utils_s.c ./engine/raycast_utils.c ./engine/ray.c
